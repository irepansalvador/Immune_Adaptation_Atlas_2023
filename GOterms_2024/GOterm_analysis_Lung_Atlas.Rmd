---
title: "GO term analysis. Lung Atlas"
...
```{r}
#in_path <- "~/Desktop/Github/Immune_Adaptation_Atlas_2023/immune_gene_list/lung_outputs/"
in_path <- "~/Desktop/Github/Immune_Adaptation_Atlas_2023/results_2024/cases/lung/"
```
  ...
  for (g in all_cells)
  {
    ...
    if (dim(df)[1] > 0)
     ...
     # GO_resX <- setReadable(GO_res, 'org.Hs.eg.db', 'ENSEMBL')
      ...
      # export as excel
      file <- paste0("./Lung/Lung_GO_term_enrichment_BP.xlsx")
...
sig_cells <-  c(
  # Tcells
  "Tcells_CD8_TRM", "Tcells_NK_CD16hi", 
  "Tcells_NK_CD56bright", "Tcells_T_reg", 
  # Bcells
  "Bcells_B_naive", "Bcells_B_plasma_IgG",
  # Myeloid
  "Myeloid_Macro_AW_CX3CR1", "Myeloid_DC_2", "Myeloid_DC_activated"
  )
